...
// OU (valable mais -- au niveau performance)

double moyenne2 = dc.Students.Select(s => s.Year_Result).Average();
Console.WriteLine("Ex 4.1");
Console.WriteLine("Moyenne = " + moyenne2);


// 4.2
int max = dc.Students.Max(s => s.Year_Result);
